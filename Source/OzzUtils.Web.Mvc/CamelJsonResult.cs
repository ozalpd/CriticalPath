...
{
    /// <summary>
    /// Produces a json with camel case property names which is native for JavaScript
    /// </summary>
    public class CamelJsonResult : JsonResult
    {
        ...
        private void CheckContext(ControllerContext context)
        {
            if (context == null)
            {
        ...
        private void PrepareContext(ControllerContext context)
        {
